...
<div class="container py-5">
    <div class="row justify-content-center">
        <div class="col-lg-8">
            ...
            <h2 class="h5 fw-bold mt-4">Analytics</h2>
            <p><?= e(SITE_NAME) ?> uses Google Analytics to understand how the site is used &mdash; for example, which pages and resources are viewed, what visitors search for, and where people run into trouble before downloading a resource. This data is limited to usage information such as pages visited, general location derived from your IP address, device and browser type, and on-site actions (like viewing a resource or clicking Download); it does not include your name, email, or other account details. Google Analytics uses cookies to distinguish visitors. We have turned off Google Signals and Ads Personalization for this data, so it is not linked to advertising or combined with any Google ad profile. You can opt out of Google Analytics tracking across all websites using the <a href="https://tools.google.com/dlpage/gaoptout" target="_blank" rel="noopener">Google Analytics Opt-out Browser Add-on</a>.</p>
